...
$page_content[] = array(
		...
		'elements'	=> array(
			'header_style'	=> array(
				...
				'moreline'	=> array(
					'header_type'		=> array(
						...
						'enable-element' => 'yes',
						'enable-id'		=> '0-pe_header_custom_enable:1-pe_header_custom_enable_1:2-pe_header_custom_enable_2:6-pe_header_custom_enable_6',
			...
			'header_style_7_area'	=> array(
				'title' => __('Header Style 7 Custom Area Setting','alterna'),
				'type' 	=> 'moreline',
				'enabled-id'		=> 'pe_header_custom_enable_6',
				'enable-group'	=> 'pe_header_custom_enable_group',
				'moreline'	=> array(
					'center-area_custom_content'		=> array(
						'name'	=> __('Header Custom Area Content Center','alterna'),
						'type'	=>	'textarea',
						'property'	=> 'header-center-area-content',
						'desc'	=> __('Support HTML CODE for your custom content!','alterna')
					),
					'right-area_custom_content'	=> array(
						'name'	=> __('Header Custom Area Content Right','alterna'),
						'type'	=>	'textarea',
						'property'	=> 'header-right-area-content',
						'desc'	=> __('Support HTML CODE for your custom content!','alterna')
					),
...
'footer-copyright-message'		=> 'Copyright &copy; 2015 <a href="http://themeforest.net/user/ThemeFocus">ThemeFocus</a>. All rights reserved.',
