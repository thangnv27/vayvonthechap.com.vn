...
function alterna_init_styles_scripts() {
	...
	if(penguin_get_options_key('bootstrap-fontawesome-cdn') == "on"){
		wp_enqueue_style( 'bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css' , array() , $ver );
		wp_enqueue_style( 'fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css' , array() , $ver );
	}else{
	...
	if(penguin_get_options_key('bootstrap-fontawesome-cdn') == "on"){
		wp_enqueue_script( 'bootstrap' , '//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js' , array('jquery') , $ver , true);
	}else{
