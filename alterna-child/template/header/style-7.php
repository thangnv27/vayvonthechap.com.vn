...
<header class="header-style-7">
    <div id="alterna-header" class="<?php echo penguin_get_options_key('fixed-enable') == "on" ? "header-fixed-enabled" : "";?>">
		...
		<div class="col-md-6">
		<div class="header-custom-container-center">
		<?php echo do_shortcode(penguin_get_options_key('header-center-area-content')); ?>
		</div>
		</div>
		<div class="col-md-3">
		...
		<div class="header-custom-container-right">
                <?php echo do_shortcode(penguin_get_options_key('header-right-area-content')); ?>
            </div>
		</div>
        </div>
